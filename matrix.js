...
Elm.Matrix.make = function (_elm) {
   ...
   var cellStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                  ...
                                                  ,{ctor: "_Tuple2",_0: "font-size",_1: "8px"}
                                                  ,{ctor: "_Tuple2",_0: "height",_1: "20px"}
                                                  ,{ctor: "_Tuple2",_0: "width",_1: "100px"}]));
   var labelStyle = $Html$Attributes.style(_U.list([]));
   ...
   var view = F2(function (address,model) {
      ...
      model.columnDimensions);
      var rowDimensionLabels = A2($List.map,
      function (x) {
         return x.label;
      },
      model.rowDimensions);
      ...
      _U.list([A2($Html.button,
              ...
              "Row Dimensions: ",
              A2($String.join,", ",rowDimensionLabels)))]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([$Html.text(A2(F2(function (x,y) {
                 return A2($Basics._op["++"],x,y);
